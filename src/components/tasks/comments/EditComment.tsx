...
export default function EditComment({ id, text, open, onOpenChange }: Props) {
  const utils = api.useContext();

  const mutation = api.comments.edit.useMutation({
    onSuccess(data) {
    ...
    onError() {
      toastError("nie udało się edytować komentarza");
    },
  });
